                    ...
                    <div class="title-heading text-center my-auto">
                        <div class="form-signin px-4 py-5 bg-white rounded-md shadow-sm">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div id="motivationField" class="mb-3" style="{{ old('role') === 'artist' ? 'display: block;' : 'display: none;' }}">
                                    ...
                                    <small class="text-muted">Cuéntanos brevemente por qué te gustaría unirte como artista. Esta información nos ayudará a conocerte mejor.</small>
                                </div>
